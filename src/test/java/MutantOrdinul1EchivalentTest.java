...
public class MutantOrdinul1EchivalentTest {
    ...
    void equivalencePartitioning() {
        Assertions.assertEquals(-1, MutantOrdinul1Echivalent.ciocolata(4, 3, Arrays.asList(1, 2, 3)));

        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(1, -5, Arrays.asList(1, 2, 3)));
        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(2, -5, Arrays.asList(1, 2, 3)));
        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(1, 200_000, Arrays.asList(1, 2, 3)));
        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(2, 200_000, Arrays.asList(1, 2, 3)));

        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 6, Arrays.asList(-1, 2, 3, 4, 5, 6)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 6, Arrays.asList(20_000, 2, 3, 4, 5, 6)));
        Assertions.assertEquals(-3 , MutantOrdinul1Echivalent.ciocolata(2, 6, Arrays.asList(-1, 2, 3, 4, 5, 6)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(2, 6, Arrays.asList(20_000, 2, 3, 4, 5, 6)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(-1)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(20_000)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(2, 1, Arrays.asList(-1)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(2, 1, Arrays.asList(20_000)));

        Assertions.assertEquals(-4, MutantOrdinul1Echivalent.ciocolata(2, 1, Arrays.asList(1)));

        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 6, Arrays.asList(1, 2, 3, 4, 5, 7)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 6, Arrays.asList(1, 2, 3, 4, 5, 6)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 6, Arrays.asList(1, 2, 3, 4, 5, 300)));
        Assertions.assertEquals(2, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(2)));

        Assertions.assertEquals(3, MutantOrdinul1Echivalent.ciocolata(2, 6, Arrays.asList(1, 2, 3, 4, 5, 7)));
        Assertions.assertEquals(0, MutantOrdinul1Echivalent.ciocolata(2, 6, Arrays.asList(1, 2, 3, 4, 5, 6)));
    }
    ...
    void boundryValueAnalysis() {
        //Pentru C
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 3, Arrays.asList(1, 1, 2)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(2, 5, Arrays.asList(1, 2, 3, 1, 4)));
        Assertions.assertEquals(-1, MutantOrdinul1Echivalent.ciocolata(3, 3, Arrays.asList(1, 2, 3)));
        Assertions.assertEquals(-1, MutantOrdinul1Echivalent.ciocolata(4, 3, Arrays.asList(1, 2 ,3)));

        //Pentru N
        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(1, 0, Arrays.asList(1, 2, 3)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 2, Arrays.asList(1, 2)));
        List<Integer> longList = new ArrayList<>();
        for (Integer i = 0; i < 100_000; i++)
            longList.add(2);
        Assertions.assertEquals(2, MutantOrdinul1Echivalent.ciocolata(1, 100_000, longList));
        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(1, 100_001, Arrays.asList(1, 2, 3)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(1)));

        //Pentru SIR
        Assertions.assertEquals(9999, MutantOrdinul1Echivalent.ciocolata(2, 2, Arrays.asList(10_000, 1)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(2, 2, Arrays.asList(2, 1)));
        Assertions.assertEquals(9999, MutantOrdinul1Echivalent.ciocolata(2, 2, Arrays.asList(10_000, 1)));
        Assertions.assertEquals(0, MutantOrdinul1Echivalent.ciocolata(2, 2, Arrays.asList(1, 1)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(1)));
        Assertions.assertEquals(10_000, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(10_000)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(0)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(10_001)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 2, Arrays.asList(10_000, 1)));
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(1, 2, Arrays.asList(2, 1)));

        //Pentru alte valori speciale
        Assertions.assertEquals(1, MutantOrdinul1Echivalent.ciocolata(2, 4, Arrays.asList(1, 33, 3, 30)));
        Assertions.assertEquals(0, MutantOrdinul1Echivalent.ciocolata(2, 4, Arrays.asList(1, 32, 3, 30)));
    ...
    void causeEffectGraphing(){
        Assertions.assertEquals(-1, MutantOrdinul1Echivalent.ciocolata(3, 2, Arrays.asList(2, 2)));
        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(1, -1, Arrays.asList(2, 3, 4)));
        Assertions.assertEquals(-2, MutantOrdinul1Echivalent.ciocolata(2, -1, Arrays.asList(2, 3, 4)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(-1)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(2, 1, Arrays.asList(-1)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(1, 3, Arrays.asList(-1, 2, 3)));
        Assertions.assertEquals(-3, MutantOrdinul1Echivalent.ciocolata(2, 3, Arrays.asList(-1, 2, 3)));
        Assertions.assertEquals(-4, MutantOrdinul1Echivalent.ciocolata(2, 1, Arrays.asList(3)));

        Assertions.assertEquals(30, MutantOrdinul1Echivalent.ciocolata(1, 1, Arrays.asList(30)));
        Assertions.assertEquals(30, MutantOrdinul1Echivalent.ciocolata(1, 4, Arrays.asList(30, 30, 63, 89)));
        Assertions.assertEquals(30, MutantOrdinul1Echivalent.ciocolata(2, 2, Arrays.asList(60, 30)));
        Assertions.assertEquals(0, MutantOrdinul1Echivalent.ciocolata(2, 2, Arrays.asList(2, 2)));
    }
